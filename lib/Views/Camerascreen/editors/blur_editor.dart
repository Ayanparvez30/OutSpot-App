...
class BlurEditorPanel extends StatefulWidget {
  final Function(BlurRegion) onAdd;
  final VoidCallback onUndo;
  final VoidCallback onReset;
  final VoidCallback onClose;

  const BlurEditorPanel({
    super.key,
    required this.onAdd,
  ...
  @override
  State<BlurEditorPanel> createState() => BlurEditorPanelState();
}

class BlurEditorPanelState extends State<BlurEditorPanel> {
      ...
      child: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Draw a rectangle on the image to blur that area',
