...
class Requests2 extends GetView<FriendListController> {
  Requests2({super.key});
  ...
  Widget _scoresRow(FriendsModel f) {
    return Row(
      children: [
        ...
        SizedBox(width: 5.w),
        Container(height: 10.h, width: 1.w, color: AppColors.MainColor),
        SizedBox(width: 5.w),
  ...
  Widget _scoresRow1(RecommendedFriend f) {
    return Row(
      children: [
        SvgPicture.asset('assets/svg/level/coinshape1.svg', height: 12),
        SizedBox(width: 4.w),
        Text(compactNumber(f.totalPoints), style: TextStyle(color: Colors.white)),
        SizedBox(width: 5.w),
        Container(height: 10.h, width: 1.w, color: AppColors.bgGradientTop),
        SizedBox(width: 5.w),
        SvgPicture.asset('assets/svg/level/coinshape2.svg', height: 12),
        SizedBox(width: 4.w),
        Text(
          compactNumber(f.thisWeekPoints),
          style: TextStyle(color: Colors.white),
